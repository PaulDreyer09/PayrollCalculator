 ...
 * @param {string} periods_per_annum_reference - Reference to periods per annum value.
 */
 ...
 * @param {string} result_reference - The reference to store the result.
 * @param {string} input_value_reference - Reference to the input value.
 * @param {string} new_periods_per_annum_reference - Reference to new periods per annum value.
 */
